...
final class ReferenciaTest extends BaseDeDatosTestCase
{
    public function testSeGeneraCorrelativaYNoSePide(): void
    {
        ...
        $primera = $this->tramites->porId($repo->crear('Primera SAS'))?->referencia;
        $segunda = $this->tramites->porId($repo->crear('Segunda SAS'))?->referencia;
    ...
    public function testElCorrelativoReiniciaCadaAnio(): void
    {
        ...
        $repo2026->crear('De diciembre SAS');
        $deEnero = $this->tramites->porId($repo2027->crear('De enero SAS'))?->referencia;
        ...
        self::assertSame('EC-2027-0002', $this->tramites->porId($repo2027->crear('Otro de enero SAS'))?->referencia);
    }

    public function testLaReferenciaNoCambiaAlAvanzarDeEtapa(): void
    {
        $id = $this->tramites->crear('Estable SAS');
    ...
    {
        $id = $this->tramites->crear('Guardada SAS');
